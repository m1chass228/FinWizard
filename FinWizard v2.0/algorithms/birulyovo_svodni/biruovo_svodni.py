...
for filename in file_names:
    ...
    print_values("D13", 3, input_ws, output_ws, rows_indent)
    # достаем Услуги/день
    print_values("A13", 4, input_ws, output_ws, rows_indent)
    # достаем Услуги/ночь
    print_values("B13", 5, input_ws, output_ws, rows_indent)
    # достаем Услуги всего
    print_values("A14", 6, input_ws, output_ws, rows_indent)
    # достаем З/п врачей
    print_values("C10", 7, input_ws, output_ws, rows_indent)
    # достаем З/п 10%
    print_values("D36", 8, input_ws, output_ws, rows_indent)
    # достаем Ритуал
    print_values("G25", 9, input_ws, output_ws, rows_indent)
    # достаем Митрохина
    print_values("G22", 10, input_ws, output_ws, rows_indent)
    # достаем Ратолог
    print_values("D18", 11, input_ws, output_ws, rows_indent)
    # достаем Дерматолог
    print_values("D19", 12, input_ws, output_ws, rows_indent)
    # достаем Стоматолог
    print_values("B33", 13, input_ws, output_ws, rows_indent)
    # достаем Белозор
    print_values("D16", 14, input_ws, output_ws, rows_indent)
    # достаем Онколог
    print_values("B34", 15, input_ws, output_ws, rows_indent)
    # достаем Кардиолог
    print_values("D17", 16, input_ws, output_ws, rows_indent)
    # достаем Чеки день
    print_values("E65", 17, input_ws, output_ws, rows_indent)
    # достаем Чеки ночь
    print_values("G65", 18, input_ws, output_ws, rows_indent)
    # достаем Чеки аптека
    print_values("I65", 19, input_ws, output_ws, rows_indent)
    # достаем Аптека
    print_values("C13", 20, input_ws, output_ws, rows_indent)

...
headers = [
    ...
    "Чеки день", "Чеки ночь", "Чеки аптека", "Аптека", "Неовет", "Веттест"
]
...
for filename in file_names:
    ...
    # достаем неовет 
    print_values("G23", 21, input_ws, output_ws, rows_indent, filename)
    # достаем веттест
    print_values("G24", 22, input_ws, output_ws, rows_indent, filename)
